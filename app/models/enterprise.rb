class Enterprise < ApplicationRecord
  ...
  has_one :enterprise_document, dependent: :destroy
  belongs_to :user, optional: true
  ...
  def self.create_restaurant_request_details(restaurant_name, restaurant_id, person_name, contact_number, role, email, area, cuisine, cr_number, bank_name, bank_account, cpr_number, owner_name, nationality, submitted_by, delivery_status, branch_no, mother_company_name, serving, block, road_number, building, unit_number, floor, other_name, other_role, other_email,country_id)
    data = create(enterprise_name: restaurant_name, restaurant_id: restaurant_id != "undefined" ? restaurant_id : "", person_name: person_name, contact_number: contact_number, role: role, email: email, area: area, cr_number: cr_number, bank_name: bank_name, bank_account: bank_account, cpr_number: cpr_number, owner_name: owner_name, nationality: nationality, submitted_by: submitted_by, delivery_status: delivery_status, branch_no: branch_no, road_number: road_number, building: building, unit_number: unit_number, floor: floor, other_user_email: role == "other" ? other_email : "", other_user_name: role == "other" ? other_name : "", other_user_role: role == "other" ? other_role : "", block: block, country_id: country_id)
  end
  ...
  def self.create_restaurant(req_restaurant, user)
    restaurant = new(title: req_restaurant.enterprise_name, user_id: user[:result].id, is_signed: false, country_id: req_restaurant.country_id)
  ...
  def downcase_restaurant_stuff
    self.enterprise_name = enterprise_name.capitalize
